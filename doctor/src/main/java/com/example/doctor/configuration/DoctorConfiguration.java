...
public class DoctorConfiguration {
	...
	public SecurityFilterChain customSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(requests -> requests.requestMatchers("/doctor/all").hasRole("user")
				.requestMatchers("/doctor/create", "/doctor/delete", "/doctor/update").hasRole("admin")
				.requestMatchers("/doctor/id").hasRole("user")
				.requestMatchers("/doctor/specilization").permitAll()
