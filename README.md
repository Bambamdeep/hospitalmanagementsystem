...
| **hospitalgateway**      | Single entry point for all the services to access          |
...
| ----- | -------------- | -------- |
| ADMIN | admin@hospital | admin123 |
| USER  | user@hospital  | user123  |

## 📚 API Documentation

| Service             | Swagger URL                                              |
| ------------------- | -------------------------------------------------------- |
| Patient Service     | [http://localhost:8081/docs](http://localhost:8081/docs) |
| Doctor Service      | [http://localhost:8082/docs](http://localhost:8082/docs) |
| Appointment Service | [http://localhost:8083/docs](http://localhost:8083/docs) |
| Department Service  | [http://localhost:8084/docs](http://localhost:8084/docs) |
| Billing Service     | [http://localhost:8085/docs](http://localhost:8085/docs) |

## 🌐 Service Endpoints

| Service             | Port | Base Endpoint                                                          | Through Gateway                                                          |
| ------------------- | ---- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Patient Service     | 8081 | [http://localhost:8081/patient](http://localhost:8081/patient)         | [http://localhost:8762/patient](http://localhost:8762/patient)           |
| Doctor Service      | 8082 | [http://localhost:8082/doctor](http://localhost:8082/doctor)           | [http://localhost:8762/doctor](http://localhost:8762/doctor)             |
| Appointment Service | 8083 | [http://localhost:8083/appointment](http://localhost:8083/appointment) | [http://localhost:8762/appointments](http://localhost:8762/appointments) |
...
| API Gateway         | 8762 | [http://localhost:8080](http://localhost:8080)                         |                                                                          |
...
**Base URL:** [http://localhost:8082/doctor](http://localhost:8082/doctor)
...
**Base URL:** [http://localhost:8083/appointment](http://localhost:8083/appointment)
...
**Base URL:** [http://localhost:8084/department](http://localhost:8084/department)
...
**Base URL:** [http://localhost:8085/bill](http://localhost:8085/bill)
...
* GET /aid/{appointmentId} → Retrieve bills for an appointment
